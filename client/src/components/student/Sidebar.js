  ...
  return (
    <div className="flex-[0.2]">
      <div className="space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-white scrollbar-thumb-gray-300 h-[33rem]">
        ...
        <div className="">
          <a href="https://sms-quiz.netlify.app/" target="_blank" rel="noopener noreferrer" className={isNotActiveStyle}>
            <AddIcon className="" />
            <h1 className="font-normal">Quiz</h1>
          </a>
          <a href="https://sunny-duckanoo-9006ed.netlify.app/" target="_blank" rel="noopener noreferrer" className={isNotActiveStyle}>
            <AddIcon className="" />
            <h1 className="font-normal">Video Call</h1>
          </a>
        </div>
      </div>
    </div>
